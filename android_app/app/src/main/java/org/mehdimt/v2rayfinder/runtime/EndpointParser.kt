...
object EndpointParser {
    ...
    private fun parseStandardUri(config: String, protocol: String): Endpoint? {
        return try {
    ...
    private fun parseVmess(config: String): Endpoint? {
        return try {
    ...
    private fun parseShadowsocks(config: String): Endpoint? {
        return try {
