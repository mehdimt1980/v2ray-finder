...
The registry may include three high-priority feeds generated by
`v2ray-source-hunter`:
...
They are fetched before ordinary curated sources. If a tier cannot be fetched
or yields no usable configs, the scanner continues with the remaining sources.
